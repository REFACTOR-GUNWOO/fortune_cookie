...
class _SynergeState extends State<Synerge> {
      ...
      builder: (BuildContext context) {
        return AlertDialog(
            ...
            contentPadding: EdgeInsets.only(
                top: 24, bottom: 48, left: 24, right: 24), // 위, 오른쪽, 아래, 왼쪽 순서
  ...
  StrokeText getTextColor() {
    if (color == "000000") {
      return StrokeText(
        text: value ?? "",
        textAlign: TextAlign.center,
        textStyle: TextStyle(fontSize: 24, color: Color(0xFFFFFFFF)),
        strokeColor: Color(0xFF33322E),
        strokeWidth: 0.1,
      );
    } else {
      return StrokeText(
        text: value ?? "",
        textAlign: TextAlign.center,
        textStyle: TextStyle(fontSize: 24, color: Color(0xFF33322E)),
        strokeColor: Color(0xFF33322E),
        strokeWidth: 0.1,
      );
    }
  ...
  Widget getSynergeResultWidget(SynergeType synergeType) {
    if (synergeType == SynergeType.color) {
      ...
      return Stack(alignment: Alignment.center, children: [
        ...
        StrokeText(
          text: value ?? "",
          textStyle: TextStyle(fontSize: 20, color: Color(0xFF33322E)),
          textAlign: TextAlign.center,
          strokeColor: Color(0xFF33322E),
          strokeWidth: 0.1,
        ),
